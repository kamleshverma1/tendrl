...
import {ActionListService} from './common/action-list';
import {AttributeListService} from './common/attribute-list';
import {FormSubmitService} from './common/form-submit';
...
angular.module(moduleName, ['angular-growl'])
    ...
    .service('ActionListService',ActionListService)
    .service('AttributeListService',AttributeListService)
