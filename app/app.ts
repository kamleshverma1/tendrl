...
import {VolumeController} from "./components/volume/volume";
import {VolumeNewController} from "./components/volume/volume-new";
import {GenerateForm} from "./components/shared/directives/generate-form/generate-form";
import {GenerateFormField} from "./components/shared/directives/generate-form-field/generate-form-field";
...
class USMApp {
    public initialize() {
        ...
        angular.module('usm-client', [
            ...
            .directive('generateForm', () => new GenerateForm())
            .directive('generateFormField', () => new GenerateFormField())
